...
import { LAYER_DEPTH_UPDATE } from '../engine/Events'
import Feature from './Feature'
import GameObject from '../engine/GameObject'

type ColorInput = string | number | Types.Display.InputColorObject

export const CAMERA_DEPTH = new WeakMap<Cameras.Scene2D.Camera, number>()
...
export default class Layer extends Feature {
    ...
    set depth(value: number) {
        ...
        if (cam !== null) CAMERA_DEPTH.set(cam, value)
