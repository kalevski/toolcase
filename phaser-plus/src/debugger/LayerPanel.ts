...
export default class LayerPanel extends Panel {
    ...
    state: { objectOptions: any[] } = { objectOptions: [] }
    ...
    override draw(): void {
        this.components.childrens = this.base.addInput(this.layerHandler, 'childs', { label: 'Objects', disabled: true, step: 1 })
        ...
        this.components.zoom = this.base.addInput(this.layerHandler.camera, 'zoom', { label: 'Zoom', min: 0.1, max: 3 })
