...
export default class OverviewPanel extends Panel {
    ...
    override draw(): void {
        this.components.features = this.base.addInput(this.state, 'features', { label: 'Features', step: 1, disabled: true })
        this.components.poolInstances = this.base.addInput(this.state, 'poolInstances', { label: 'Pool', step: 1, disabled: true })
        this.components.gameObjects = this.base.addMonitor(this.state, 'gameObjects', { view: 'graph', label: 'Objects', max: 100, min: 0 })
