// Pure classifier for the cert-issuance pre-flight (quaykeeper_better.md B2, the
 ...
 * else's server), and the ingress comparison is skipped when Quaykeeper doesn't know its
