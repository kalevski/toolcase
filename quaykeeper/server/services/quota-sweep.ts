...
declare global {
    var __quaykeeperQuotaSweep: { timer: ReturnType<typeof setInterval> } | undefined
}
...
export function ensureQuotaSweepStarted(): void {
    if (globalThis.__quaykeeperQuotaSweep) return
    ...
    timer.unref?.()
    globalThis.__quaykeeperQuotaSweep = { timer }
