...
// Tab title + description follow the owner-set app name (§13). Read server-side per
// request from the settings service; fall back to the defaults during the build trace
// (no DB yet) or if the read throws, so metadata never breaks a render.
