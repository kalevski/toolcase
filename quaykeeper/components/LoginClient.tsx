...
const ERRORS: Record<string, string> = {
    ...
    not_allowed: 'Your GitHub account is not allowed to access Quaykeeper.',
...
export function LoginClient({ error }: { error?: string }) {
    ...
    return (
        <div className="quaykeeper-login">
            {message && !connecting && (
            ...
            {connecting ? (
                <div className="quaykeeper-login-redirect" role="status" aria-busy="true">
                    <tc-spinner type="border" />
                    <span>Redirecting to GitHub…</span>
                </div>
            ) : (
                <div className="quaykeeper-login-body">
