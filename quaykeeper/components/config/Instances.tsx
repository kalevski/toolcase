...
const INSTANCE_COLUMNS: TableColumn[] = [
    {
        ...
        render: (row: InstanceRow) =>
            `<button type="button" class="btn btn-link p-0 quaykeeper-admin-mono" data-action="view" data-id="${escapeHtml(row.id)}">${escapeHtml(row.name)}</button>`,
    },
    {
        key: 'project',
        header: 'Project',
                ...
                <div className="quaykeeper-admin-section">
                    ...
                    <div className="quaykeeper-instance-toolbar">
                        {projectOptions.length > 1 && (
                            <div className="quaykeeper-project-filter">
                                <SelectField
                                    size="sm"
                                    value={activeProject}
                        ...
                        <div className="quaykeeper-tag-filter" role="group" aria-label="Filter by tags">
                            {allTags.map((t) => {
