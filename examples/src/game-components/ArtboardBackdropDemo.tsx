        ...
        <div className="row">
            <div className="col-12">
                ...
                <div className="d-flex flex-column gap-4 mt-4">
                    ...
                    <gc-panel bordered>
                        {/* @ts-ignore */}
                        <gc-panel-header header-title="Kind: dark (default)" />
                        {/* @ts-ignore */}
                    ...
                    <gc-panel bordered>
                        ...
                        <gc-panel-header header-title="Kind: scene" />
                        {/* @ts-ignore */}
                    ...
                    <gc-panel bordered>
                        ...
                        <gc-panel-header header-title="Kind: parch" />
                        {/* @ts-ignore */}
                    ...
                    <gc-panel bordered>
                        ...
                        <gc-panel-header header-title="Padding: none" />
                        {/* @ts-ignore */}
