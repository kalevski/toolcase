            ...
            <div className="row">
                <div className="col-12">
                    ...
                    <div className="d-flex flex-column gap-4 mt-4">
                        <tc-section-card title="Default list group — static items">
                            {/* @ts-ignore */}
                            <tc-list-group>
                                {/* @ts-ignore */}
                        ...
                        <tc-section-card title="Linked items with href">
                            {/* @ts-ignore */}
                            <tc-list-group>
                                {/* @ts-ignore */}
                                <tc-list-group-item href="#" active>
                                    An active link item
                                </tc-list-group-item>
                                {/* @ts-ignore */}
                                <tc-list-group-item href="#">A second link item</tc-list-group-item>
                                {/* @ts-ignore */}
                                <tc-list-group-item href="#" disabled>
                        ...
                        <tc-section-card title="Button items with action">
                            {/* @ts-ignore */}
                            <tc-list-group>
                                {/* @ts-ignore */}
                                <tc-list-group-item action active>
                                    The current button
                                </tc-list-group-item>
                                {/* @ts-ignore */}
                                <tc-list-group-item action>A second button item</tc-list-group-item>
                                {/* @ts-ignore */}
                                <tc-list-group-item action disabled>
                        ...
                        <tc-section-card title="Contextual variants">
                            {/* @ts-ignore */}
                            <tc-list-group>
                                {/* @ts-ignore */}
                                <tc-list-group-item>Default item</tc-list-group-item>
                                {/* @ts-ignore */}
                                <tc-list-group-item variant="primary">
                                    A primary item
                                </tc-list-group-item>
                                {/* @ts-ignore */}
                                <tc-list-group-item variant="secondary">
                                    A secondary item
                                </tc-list-group-item>
                                {/* @ts-ignore */}
                                <tc-list-group-item variant="success">
                                    A success item
                                </tc-list-group-item>
                                {/* @ts-ignore */}
                                <tc-list-group-item variant="danger">
                                    A danger item
                                </tc-list-group-item>
                                {/* @ts-ignore */}
                                <tc-list-group-item variant="warning">
                                    A warning item
                                </tc-list-group-item>
                                {/* @ts-ignore */}
                                <tc-list-group-item variant="info">An info item</tc-list-group-item>
                                {/* @ts-ignore */}
                                <tc-list-group-item variant="light">
                                    A light item
                                </tc-list-group-item>
                                {/* @ts-ignore */}
                        ...
                        <tc-section-card title="flush — removes outer borders">
                            {/* @ts-ignore */}
                            <tc-list-group flush>
                                {/* @ts-ignore */}
                                <tc-list-group-item>An item</tc-list-group-item>
                        ...
                        <tc-section-card title="numbered — ordered list with counters">
                            {/* @ts-ignore */}
                        ...
                        <tc-section-card title="horizontal — inline layout">
                            {/* @ts-ignore */}
                        ...
                        <tc-section-card title='horizontal="md" — horizontal at md breakpoint and above'>
                            {/* @ts-ignore */}
