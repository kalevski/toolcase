...
const TIERS_FULL = [
    {
        ...
        logos: [
            {
                src: 'https://placehold.co/160x64/e2e8f0/64748b?text=Acme+Corp',
                alt: 'Acme Corp',
                href: '#',
            },
            {
                src: 'https://placehold.co/160x64/e2e8f0/64748b?text=Globex',
                alt: 'Globex',
                href: '#',
            },
        ],
    },
    {
        ...
        logos: [
            {
                src: 'https://placehold.co/120x48/e2e8f0/64748b?text=Initech',
                alt: 'Initech',
                href: '#',
            },
            {
                src: 'https://placehold.co/120x48/e2e8f0/64748b?text=Umbrella',
                alt: 'Umbrella',
                href: '#',
            },
            {
                src: 'https://placehold.co/120x48/e2e8f0/64748b?text=Stark+Ind',
    ...
    },
    {
        ...
        logos: [
            ...
            {
                src: 'https://placehold.co/96x38/e2e8f0/64748b?text=Dunder+Mifflin',
                alt: 'Dunder Mifflin',
                href: '#',
            },
            {
                src: 'https://placehold.co/96x38/e2e8f0/64748b?text=Vandelay',
    ...
    },
    {
        ...
        logos: [
            {
                src: 'https://placehold.co/72x28/e2e8f0/64748b?text=Lo+Fidelity',
                alt: 'Lo Fidelity',
            },
            {
                src: 'https://placehold.co/72x28/e2e8f0/64748b?text=Bluth+Co',
                alt: "Bluth's Original",
                href: '#',
            },
            {
                src: 'https://placehold.co/72x28/e2e8f0/64748b?text=Planet+Expr',
                alt: 'Planet Express',
            },
            {
                src: 'https://placehold.co/72x28/e2e8f0/64748b?text=Soylent',
                alt: 'Soylent Corp',
                href: '#',
            },
            {
                src: 'https://placehold.co/72x28/e2e8f0/64748b?text=Aperture',
                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="d-flex flex-column gap-4 mt-4">
                            <tc-section-card title="Multiple tiers at all sizes (with title attribute)">
                                {/* @ts-ignore */}
                                <tc-sponsor-wall ref={fullRef} title="Our Sponsors" />
                            </tc-section-card>

                            <tc-section-card title="Single tier — no title, mixed linked / unlinked logos">
                                {/* @ts-ignore */}
