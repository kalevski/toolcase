                        ...
                        <div className="d-flex flex-column gap-4 mt-4">
                            <SectionCard title="Kinds">
                                ...
                                <p className="mt-2 mb-0 text-muted" style={{ fontSize: '13px' }}>
                                    <code>kind="back"</code> renders a chevron-left; <code>kind="close"</code> renders an ×.
                                </p>
                            </SectionCard>
                            ...
                            <SectionCard title="Custom size">
                                ...
                                <p className="mt-2 mb-0 text-muted" style={{ fontSize: '13px' }}>
                                    The <code>size</code> attribute accepts a plain number (px). Default is 32 px (2 rem).
                                </p>
                            </SectionCard>
                            ...
                            <SectionCard title="Custom aria-label">
                                ...
                                <p className="mt-2 mb-0 text-muted" style={{ fontSize: '13px' }}>
                                    The <code>label</code> attribute overrides the default aria-label ("Back" / "Close").
                                </p>
                            </SectionCard>
                            ...
                            <SectionCard title="Events — click the buttons">
                                <div className="d-flex flex-wrap gap-3 align-items-center">
                                    {/* @ts-ignore */}
                                    <tc-nav-button
                                        kind="back"
                                ...
                                <div className="mt-3">
                                    ...
                                    {log.length === 0 ? (
                                        <span className="text-muted">Click a button to see events…</span>
                                    ) : (
                                        <ul className="mb-0">
                                            {log.map((line, i) => (
                                ...
                                <div className="d-flex flex-wrap gap-3 align-items-center">
                                    ...
                                    <tc-nav-button
                                        ...
                                        style={{
                                            ...
                                            '--bs-nav-button-hover-bg': 'rgba(30, 41, 59, 0.08)',
                                            '--bs-nav-button-border-color': 'var(--tc-border)',
                                            '--bs-nav-button-hover-border-color': 'var(--tc-border-strong)',
                                        } as React.CSSProperties}
                                    />
                                </div>
                                <p className="mt-2 mb-0 text-muted" style={{ fontSize: '13px' }}>
                                    Override <code>--bs-nav-button-*</code> on the host to retheme the button.
                                </p>
                            </SectionCard>
                        </div>
                    </div>
