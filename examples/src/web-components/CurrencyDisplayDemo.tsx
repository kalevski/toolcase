                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="d-flex flex-column gap-4 mt-4">
                            ...
                            <SectionCard title="Symbol icons &amp; large amounts">
                                <div className="d-flex flex-wrap gap-5 align-items-end">
                                    {/* @ts-ignore */}
                                    <tc-currency-display label="Gems" currency-icon="◆" amount="1250000"></tc-currency-display>
                                    {/* @ts-ignore */}
                                    <tc-currency-display label="Experience" currency-icon="XP" amount="34000"></tc-currency-display>
                                </div>
                            </SectionCard>

                            <SectionCard title="Custom icon color">
                                <div className="d-flex flex-wrap gap-5 align-items-end">
                                    {/* @ts-ignore */}
                                    <tc-currency-display label="Credits" currency-icon="◆" amount="500" color="var(--tc-accent)"></tc-currency-display>
                                    {/* @ts-ignore */}
                                    <tc-currency-display label="Health" currency-icon="●" amount="42" color="var(--tc-success)"></tc-currency-display>
                                    {/* @ts-ignore */}
                                    <tc-currency-display label="Tokens" currency-icon="◆" amount="128" color="#a855f7"></tc-currency-display>
                                </div>
                            </SectionCard>
                            ...
                            <SectionCard title="Custom font size">
                                <div className="d-flex flex-wrap gap-5 align-items-end">
                                    {/* @ts-ignore */}
                                    <tc-currency-display label="Compact" currency-icon="$" amount="980" font-size="18"></tc-currency-display>
                                    {/* @ts-ignore */}
                                    <tc-currency-display label="Headline" currency-icon="$" amount="980" font-size="40"></tc-currency-display>
                                </div>
                            </SectionCard>

                            <SectionCard title="Label-less &amp; icon-less (amount only)">
                                <div className="d-flex flex-wrap gap-5 align-items-end">
                                    {/* @ts-ignore */}
                                    <tc-currency-display currency-icon="$" amount="64"></tc-currency-display>
                                    {/* @ts-ignore */}
