...
const HUMANOID_SLOTS = [
    ...
    { id: 'amulet', label: 'Amulet', x: 18, y: 18, item: { id: 'amulet', name: 'Amulet', icon: 'A' } },
    { id: 'chest', label: 'Chest', x: 50, y: 34, item: { id: 'plate', name: 'Plate Armor', icon: 'C' } },
    { id: 'main-hand', label: 'Main', x: 14, y: 46, item: { id: 'sword', name: 'Longsword', icon: 'S' } },
    { id: 'off-hand', label: 'Off', x: 86, y: 46, item: { id: 'shield', name: 'Shield', icon: 'D' } },
    { id: 'gloves', label: 'Gloves', x: 18, y: 64, item: { id: 'gloves', name: 'Gauntlets', icon: 'G' } },
    { id: 'belt', label: 'Belt', x: 50, y: 60, item: null },
    { id: 'ring', label: 'Ring', x: 82, y: 64, item: { id: 'ring', name: 'Signet Ring', icon: 'R' } },
    { id: 'legs', label: 'Legs', x: 50, y: 78, item: { id: 'greaves', name: 'Greaves', icon: 'L' } },
    { id: 'feet', label: 'Feet', x: 50, y: 94, item: { id: 'boots', name: 'Boots', icon: 'B', qty: 2 } },
]

const COMPACT_SLOTS = [
    { id: 'weapon', label: 'Weapon', x: 22, y: 28, item: { id: 'blaster', name: 'Blaster', icon: 'W' } },
    { id: 'armor', label: 'Armor', x: 50, y: 50, item: { id: 'vest', name: 'Vest', icon: 'V' } },
    { id: 'mod', label: 'Mod', x: 78, y: 28, item: null },
    { id: 'boost', label: 'Boost', x: 50, y: 82, item: { id: 'boost', name: 'Jetpack', icon: 'J' } },
]
                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="d-flex flex-column gap-4 mt-4">
                            <SectionCard title="Full humanoid loadout">
                                {/* @ts-ignore */}
                                <tc-equipment-doll ref={mainRef} selected-id={selected} width="280" height="400" />
                                <p className="mt-3 mb-0 text-secondary">
                                    Selected slot: <code>{selected || '—'}</code>
                                </p>
                            </SectionCard>

                            <SectionCard title="Compact loadout (4 slots)">
                                {/* @ts-ignore */}
                                <tc-equipment-doll ref={compactRef} width="220" height="260" slot-size="48" />
                            </SectionCard>

                            <SectionCard title="Custom text silhouette">
                                {/* @ts-ignore */}
                                <tc-equipment-doll ref={customRef} silhouette="PC" width="280" height="360" />
                            </SectionCard>
                        </div>
                    </div>
                </div>
