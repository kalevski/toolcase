            ...
            <div className="row">
                <div className="col-12">
                    ...
                    <div className="d-flex flex-column gap-4 mt-4">
                        ...
                        <tc-section-card title="Scrollable with overflow content">
                        ...
                        <tc-section-card title="Custom padding via CSS property">
                            <div style={{ border: '1px solid var(--tc-border)', height: '160px' }}>
                                {/* @ts-ignore */}
                                <tc-dashboard-content
                                    style={
                                        {
                                            height: '100%',
                                            '--bs-dashboard-content-padding': '2.5rem',
                                        } as React.CSSProperties
                                    }
                                >
                                    <div style={{ color: 'var(--tc-text)' }}>
                                        Content with extra padding applied via{' '}
                                        <code>--bs-dashboard-content-padding</code>.
                                    </div>
                                    {/* @ts-ignore */}
                                </tc-dashboard-content>
                            </div>
