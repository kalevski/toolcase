                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="d-flex flex-column gap-4 mt-4">
                            <tc-section-card title="Mixed buffs & debuffs (buffs JS property)">
                                {/* @ts-ignore */}
                                <tc-buff-bar ref={mixedRef} />
                            </tc-section-card>

                            <tc-section-card title="Long-duration buffs with stacks">
                                {/* @ts-ignore */}
                                <tc-buff-bar ref={longRef} />
                            </tc-section-card>

                            <tc-section-card title="Debuffs only">
                                {/* @ts-ignore */}
                                <tc-buff-bar ref={debuffsRef} />
                            </tc-section-card>

                            <tc-section-card title="Larger icons & wider gap (icon-size / gap attributes)">
                                {/* @ts-ignore */}
