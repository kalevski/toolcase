                    ...
                    <div className="d-flex flex-column gap-4 mt-4">
                        <SectionCard title="Variants">
                            <div className="d-flex flex-column gap-2">
                                {/* @ts-ignore */}
                                <tc-alert variant="primary">A primary alert — check it out!</tc-alert>
                                {/* @ts-ignore */}
                                <tc-alert variant="secondary">A secondary alert — check it out!</tc-alert>
                                {/* @ts-ignore */}
                                <tc-alert variant="success">A success alert — check it out!</tc-alert>
                                {/* @ts-ignore */}
                                <tc-alert variant="danger">A danger alert — check it out!</tc-alert>
                                {/* @ts-ignore */}
                                <tc-alert variant="warning">A warning alert — check it out!</tc-alert>
                                {/* @ts-ignore */}
                        ...
                        <SectionCard title="Dismissible — click × to close with fade transition">
                            <div className="d-flex flex-column gap-2">
                                {/* @ts-ignore */}
