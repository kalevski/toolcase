                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="d-flex flex-column gap-4 mt-4">
                            <tc-section-card title="Avatar images with profile links (title attribute)">
                                {/* @ts-ignore */}
                                <tc-contributor-wall ref={avatarsRef} title="Top Contributors" />
                            </tc-section-card>

                            <tc-section-card title="Mixed — images and initials tiles">
                                {/* @ts-ignore */}
                                <tc-contributor-wall ref={mixedRef} title="All Contributors" />
                            </tc-section-card>

                            <tc-section-card title="maxVisible overflow chip (max-visible=5)">
                                {/* @ts-ignore */}
                                <tc-contributor-wall
                                    ref={overflowRef}
                                    title="Contributors"
                            ...
                            <tc-section-card title="No profile links (presentational only)">
                                {/* @ts-ignore */}
