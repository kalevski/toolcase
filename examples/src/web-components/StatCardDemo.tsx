            ...
            <div className="row">
                <div className="col-12">
                    ...
                    <div className="d-flex flex-column gap-4 mt-4">
                        <tc-section-card title="Basic — label and value">
                        ...
                        <tc-section-card title="With unit">
                            <div style={{ maxWidth: 280 }}>
                                {/* @ts-ignore */}
                        ...
                        <tc-section-card title="Delta kinds">
                            <div
                                style={{
                                    display: 'grid',
                        ...
                        <tc-section-card title="With helper text">
                            <div style={{ maxWidth: 280 }}>
                                {/* @ts-ignore */}
                                <tc-stat-card
                                    label="Error Rate"
                        ...
                        <tc-section-card title="With footer">
                            <div style={{ maxWidth: 280 }}>
                                {/* @ts-ignore */}
                                <tc-stat-card
                        ...
                        <tc-section-card title="Dashboard grid — all features">
                            <div
                                style={{
                                    display: 'grid',
