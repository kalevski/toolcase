                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="d-flex flex-column gap-4 mt-4">
                            <tc-section-card title="Default (80px bars, slate ink)">
                                <p className="mb-3" style={{ opacity: 0.85 }}>
                                    Toggle <code>[show]</code> to slide the bars in and out. The
                                    default bar height is 80 px; the default color is{' '}
                                    <code>var(--tc-ink)</code>.
                                </p>
                            ...
                            <tc-section-card title='Tall bars (bar-height="140px")'>
                                <p className="mb-3" style={{ opacity: 0.85 }}>
                                    A taller cinematic cut — useful for a more extreme widescreen
                                    ratio. Pass any CSS length to <code>bar-height</code>.
                                </p>
                                <div style={stageStyle}>
                                    <span style={sceneLabelStyle}>Scene viewport</span>
                                    {/* @ts-ignore */}
                            ...
                            <tc-section-card title="Custom color + faster transition">
                                <p className="mb-3" style={{ opacity: 0.85 }}>
                                    <code>bar-color</code> accepts any CSS color value;{' '}
                                    <code>duration</code> controls the slide speed (default{' '}
                                    <code>0.4s</code>).
                                </p>
                                <div style={stageStyle}>
                                    <span style={sceneLabelStyle}>Scene viewport</span>
