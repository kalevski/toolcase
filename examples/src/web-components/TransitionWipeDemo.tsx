                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="d-flex flex-column gap-4 mt-4">
                            ...
                            <SectionCard title="Custom wipe-color (slate accent)">
                                <p className="mb-3" style={{ opacity: 0.85 }}>
                                    <code>wipe-color</code> accepts any CSS color or custom property.
                                    Here it is set to <code>var(--tc-app-accent)</code> (the design
                                    system ink accent) for a branded wipe.
                                </p>
                                <button
                                    className="btn btn-primary"
                                    onClick={() => {
                            ...
                            <SectionCard title="Long duration (800 ms)">
                                <p className="mb-3" style={{ opacity: 0.85 }}>
