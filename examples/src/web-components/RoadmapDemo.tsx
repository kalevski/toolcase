...
const COLUMNS = [
    {
        ...
        items: [
            ...
            {
                title: 'CSV export',
                description: 'Stream large tables without blocking.',
                tags: ['data'],
            },
        ...
        items: [
            {
                ...
                description: 'Cursors and selections across collaborators.',
                tags: ['rt'],
            },
            {
                title: 'Audit log viewer',
                description: 'Filterable, paginated activity stream.',
                tags: ['security'],
            },
        ],
    },
    ...
    },
    {
        ...
        items: [
            {
                title: 'Offline mode',
                description: 'Local-first sync with conflict resolution.',
                tags: ['research'],
            },
        ],
    },
...
const STACKED_COLUMNS = [
        ...
        items: [
            {
                ...
                description: 'Self-serve plan changes and invoices.',
                tags: ['billing'],
            },
        ],
    },
        ...
        items: [
            {
                ...
                description: 'Curated starting points for new projects.',
                tags: ['onboarding'],
            },
    ...
    },
    {
        ...
        items: [
            {
                title: 'AI summaries',
                description: 'One-click recaps of long threads.',
                tags: ['ai'],
            },
        ],
    },
                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="d-flex flex-column gap-4 mt-4">
                            <tc-section-card title="Kanban layout — four status columns, clickable items">
                                {/* @ts-ignore */}
                                <tc-roadmap
                                    ref={kanbanRef}
                                    layout="kanban"
                            ...
                            <tc-section-card title="Stacked layout — custom column titles">
                                {/* @ts-ignore */}
