                    ...
                    <div className="d-flex flex-column gap-4 mt-4">
                        <tc-section-card title="Variants (text attribute)">
                            <div className="d-flex flex-column gap-2">
                                ...
                                <tc-helper-text
                                    variant="warning"
                                    text="This field will be publicly visible"
                                ></tc-helper-text>
                                {/* @ts-ignore */}
                                <tc-helper-text
                                    variant="error"
                        ...
                        <tc-section-card title="Slotted children">
                            <div className="d-flex flex-column gap-2">
                                {/* @ts-ignore */}
                                <tc-helper-text variant="default">
                                    Use a mix of letters, numbers and symbols
                                </tc-helper-text>
                                {/* @ts-ignore */}
                                <tc-helper-text variant="error">
                                    Email already in use — <a href="#">sign in instead</a>
                                </tc-helper-text>
                            </div>
                        </tc-section-card>

                        <tc-section-card title="Custom icon override">
                            <div className="d-flex flex-column gap-2">
                                {/* @ts-ignore */}
                                <tc-helper-text
                                    variant="default"
                                ...
                                <tc-helper-text
                                    variant="warning"
                                    icon="Clock"
                                    text="Changes take effect within 24 hours"
                                ></tc-helper-text>
                            </div>
                        </tc-section-card>

                        <tc-section-card title="Paired with input via aria-describedby">
