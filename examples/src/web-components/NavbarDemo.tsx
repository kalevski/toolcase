            ...
            <div className="row">
                <div className="col-12">
                    ...
                    <div className="d-flex flex-column gap-4 mt-4">
                        <tc-section-card title="Default — glass chrome, brand mark + links, collapses at lg">
                            {/* @ts-ignore */}
                        ...
                        <tc-section-card title="expand=md — borderless icon toggler, sheet-style collapse below md">
                            {/* @ts-ignore */}
                        ...
                        <tc-section-card title="variant=dark — ink surface, the brand dot keeps the signature cyan">
                            {/* @ts-ignore */}
                        ...
                        <tc-section-card title="sticky=top — the glass surface blurs content scrolling underneath">
                            <div
                                style={{
                                    height: '160px',
                                    overflowY: 'auto',
                            ...
                            >
                                ...
                                <div className="p-3">
                                    <p>
                                        Scroll this region — the bar stays pinned and the
                                        translucent surface picks up the content moving beneath it.
                                    </p>
