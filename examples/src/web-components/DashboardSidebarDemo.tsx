            ...
            <div className="row">
                <div className="col-12">
                    ...
                    <div className="d-flex flex-column gap-4 mt-4">
                        <tc-section-card title="All three regions">
                            <div
                                style={{
                        ...
                        <tc-section-card title="Brand region only">
                            <div
                                style={{
                                    border: '1px solid var(--tc-border)',
                                    height: '200px',
                        ...
                        <tc-section-card title="Custom width via CSS property">
                            <div
                                style={{
                                    border: '1px solid var(--tc-border)',
                                    height: '200px',
                            ...
                            >
                                ...
                                <tc-dashboard-sidebar
                                    style={
                                        {
                                            height: '100%',
                                            '--bs-dashboard-sidebar-width': '11rem',
