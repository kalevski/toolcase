                        ...
                        <div className="d-flex flex-column gap-4 mt-4">
                            ...
                            <tc-section-card title="Loading state">
                                <p className="text-secondary small mb-2">
                                    The spinner is centred over the label and sized to the text. The
                                    label is hidden (not removed), so the button keeps its resting
                                    width and stays non-interactive.
                                </p>
                                <div className="d-flex flex-wrap align-items-center gap-2">
                                    {/* @ts-ignore */}
                                    <tc-cool-button
                            ...
                            <tc-section-card title="Loading — interactive (stable width)">
                                <p className="text-secondary small mb-2">
                                    Click to start a 1.6s task. Watch the button: it does not resize
                                    or shift when the spinner appears or disappears.
                                </p>
                                <div className="d-flex flex-wrap align-items-center gap-2">
                                    {/* @ts-ignore */}
                                    <tc-cool-button
                            ...
                            <tc-section-card title="Loading — combined with an addon">
                                <p className="text-secondary small mb-2">
                                    With a leading addon the spinner replaces the icon glyph; with a
                                    trailing addon it overlays the label and the addon glyph stays
                                    put.
                                </p>
                                <div className="d-flex flex-wrap align-items-center gap-2">
                                    {/* @ts-ignore */}
                            ...
                            <tc-section-card title="Addon — attribute (right, default)">
                                <p className="text-secondary small mb-2">
                                    Addon glyphs are sized to the label and vertically centred
                                    against it, with a consistent gap and a 1px divider.
                                </p>
                                <div className="d-flex flex-wrap align-items-center gap-2">
                                    {/* @ts-ignore */}
                                    <tc-cool-button
                            ...
                            <tc-section-card title="Addon — attribute (left)">
                                <div className="d-flex flex-wrap align-items-center gap-2">
                                    {/* @ts-ignore */}
                                    <tc-cool-button
                                        ref={addonLeftRef}
                            ...
                            <tc-section-card title="Addon — slot children (right)">
                                <p className="text-secondary small mb-2">
                                    Slotted addon content is centred and aligned to the label too —
                                    here a mono version tag and a glyph that inherits the label
                                    sizing.
                                </p>
                                <div className="d-flex flex-wrap align-items-center gap-2">
                                    {/* @ts-ignore */}
                            ...
                            <tc-section-card title="Slotted label (default children)">
                                <div className="d-flex flex-wrap gap-2">
                                    {/* @ts-ignore */}
