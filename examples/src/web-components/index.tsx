...
export const webComponentExamples: WebComponentDef[] = [
    ...
    { key: 'character-select', category: 'Forms', element: <CharacterSelectDemo /> },
    ...
    { key: 'list-card', category: 'Components', element: <ListCardDemo /> },
    ...
    { key: 'skill-tree', category: 'Components', element: <SkillTreeDemo /> },
    ...
    { key: 'guild-panel', category: 'Content', element: <GuildPanelDemo /> },
    ...
    { key: 'party-panel', category: 'Components', element: <PartyPanelDemo /> },
    ...
    { key: 'journal', category: 'Components', element: <JournalDemo /> },
    ...
    { key: 'stat-row', category: 'Components', element: <StatRowDemo /> },
