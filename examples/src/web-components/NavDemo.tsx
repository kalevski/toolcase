            ...
            <div className="row">
                <div className="col-12">
                    ...
                    <div className="d-flex flex-column gap-4 mt-4">
                        <SectionCard title="variant=tabs — tabbed panes with Bootstrap Tab plugin">
                            {/* @ts-ignore */}
                            <tc-nav variant="tabs">
                                {/* @ts-ignore */}
                                <tc-nav-item href="#tc-nav-tab1" active>Home</tc-nav-item>
                                {/* @ts-ignore */}
                                <tc-nav-item href="#tc-nav-tab2">Profile</tc-nav-item>
                                {/* @ts-ignore */}
                                <tc-nav-item href="#tc-nav-tab3">Contact</tc-nav-item>
                                {/* @ts-ignore */}
                                <tc-nav-item href="#tc-nav-tab4" disabled>Disabled</tc-nav-item>
                            {/* @ts-ignore */}
                            </tc-nav>
                            <div className="tab-content mt-3">
                                <div className="tab-pane show active" id="tc-nav-tab1">
                                    <p>Home tab content. This pane is shown first because the item has the <code>active</code> attribute.</p>
                                </div>
                                <div className="tab-pane" id="tc-nav-tab2">
                                    <p>Profile tab content. Click the Profile tab above to show this pane.</p>
                                </div>
                                <div className="tab-pane" id="tc-nav-tab3">
                                    <p>Contact tab content. Click the Contact tab above to show this pane.</p>
                                </div>
                        ...
                        <SectionCard title="variant=pills — pill navigation with switchable panes">
                            {/* @ts-ignore */}
                            <tc-nav variant="pills">
                                {/* @ts-ignore */}
                                <tc-nav-item href="#tc-nav-pill1" active>Overview</tc-nav-item>
                                {/* @ts-ignore */}
                            ...
                            <div className="tab-content mt-3">
                                <div className="tab-pane show active" id="tc-nav-pill1">
                                    <p>Overview content. Pills use the same Bootstrap Tab plugin as tabs.</p>
                                </div>
                                <div className="tab-pane" id="tc-nav-pill2">
                                    <p>Settings content. Click the Settings pill to navigate here.</p>
                                </div>
                                <div className="tab-pane" id="tc-nav-pill3">
                                    <p>Activity content. Click the Activity pill to navigate here.</p>
                                </div>
                            </div>
                        </SectionCard>

                        <SectionCard title="variant=underline — underline style (no tab plugin)">
                            {/* @ts-ignore */}
                            <tc-nav variant="underline">
                                {/* @ts-ignore */}
                                <tc-nav-item href="#" active>Active</tc-nav-item>
                                {/* @ts-ignore */}
                                <tc-nav-item href="#">Link</tc-nav-item>
                                {/* @ts-ignore */}
                                <tc-nav-item href="#">Another</tc-nav-item>
                                {/* @ts-ignore */}
                                <tc-nav-item href="#" disabled>Disabled</tc-nav-item>
                            {/* @ts-ignore */}
                            </tc-nav>
                        </SectionCard>

                        <SectionCard title="fill — items fill available width equally">
                            {/* @ts-ignore */}
                        ...
                        <SectionCard title="justified — items have equal widths">
                            {/* @ts-ignore */}
                        ...
                        <SectionCard title="vertical — stacked column layout">
                            {/* @ts-ignore */}
                            <tc-nav variant="pills" vertical style={{ width: '200px' }}>
                                {/* @ts-ignore */}
                                <tc-nav-item href="#" active>Dashboard</tc-nav-item>
                                {/* @ts-ignore */}
                                <tc-nav-item href="#">Profile</tc-nav-item>
                                {/* @ts-ignore */}
                                <tc-nav-item href="#">Settings</tc-nav-item>
                                {/* @ts-ignore */}
                                <tc-nav-item href="#" disabled>Billing</tc-nav-item>
                            {/* @ts-ignore */}
                            </tc-nav>
                        </SectionCard>
                    </div>
