                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="d-flex flex-column gap-4 mt-4">
                            <tc-section-card title="Default — hover/focus trigger">
                                {/* @ts-ignore */}
                            ...
                            <tc-section-card title='trigger="click" — shows on click'>
                                {/* @ts-ignore */}
                            ...
                            <tc-section-card title="html — render HTML inside the tooltip">
                                {/* @ts-ignore */}
                            ...
                            <tc-section-card title='trigger="manual" — programmatic control'>
                                ...
                                <tc-tooltip
                                    ref={manualRef}
                                    title="Controlled via show() / hide() / toggle()."
                                    trigger="manual"
                                >
