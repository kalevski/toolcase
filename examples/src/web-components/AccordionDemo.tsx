            ...
            <div className="row">
                <div className="col-12">
                    ...
                    <div className="d-flex flex-column gap-4 mt-4">
                        <tc-section-card title="Default accordion — one item open at a time">
                            {/* @ts-ignore */}
                            <tc-accordion>
                                {/* @ts-ignore */}
                                <tc-accordion-item header="First item" open>
                                    <p className="mb-0">
                                        This is the first item's content. It starts expanded because
                                        of the <code>open</code> attribute.
                                    </p>
                                    {/* @ts-ignore */}
                                </tc-accordion-item>
                                {/* @ts-ignore */}
                                <tc-accordion-item header="Second item">
                                    <p className="mb-0">
                                        This is the second item's content. Opening this will close
                                        the first one.
                                    </p>
                                    {/* @ts-ignore */}
                                </tc-accordion-item>
                        ...
                        <tc-section-card title="flush — borderless accordion aligned to parent edges">
                            {/* @ts-ignore */}
                            <tc-accordion flush>
                                {/* @ts-ignore */}
                        ...
                        <tc-section-card title="always-open — multiple items can stay open simultaneously">
                            {/* @ts-ignore */}
                            <tc-accordion always-open>
                                ...
                                <tc-accordion-item header="Always-open item two" open>
                                    <p className="mb-0">
                                        Both items start expanded and opening/closing one doesn't
                                        affect the other.
                                    </p>
                                    {/* @ts-ignore */}
                                </tc-accordion-item>
