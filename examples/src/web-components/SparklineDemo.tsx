                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="d-flex flex-column gap-4 mt-4">
                            <tc-section-card title="Line type (data attribute)">
                                <p
                                    className="mb-2"
                                    style={{ fontSize: '0.85rem', color: 'var(--tc-text-muted)' }}
                                >
                                    Authored in plain HTML via the comma-separated <code>data</code>{' '}
                                    attribute.
                                </p>
                                {/* @ts-ignore */}
                                <tc-sparkline
                                    data="10,25,18,42,30,55,40,68,52,75"
                                    width="160"
                                    height="40"
                                ></tc-sparkline>
                            </tc-section-card>

                            <tc-section-card title="Bar type (JS property)">
                                <p
                                    className="mb-2"
                                    style={{ fontSize: '0.85rem', color: 'var(--tc-text-muted)' }}
                                >
                                    Data set via the <code>data</code> JS property on the element
                                    ref.
                                </p>
                                {/* @ts-ignore */}
                                <tc-sparkline
                            ...
                            <tc-section-card title="Inline within a metric">
                                <p className="mb-0" style={{ fontSize: '1rem', lineHeight: '2' }}>
                                    Revenue <strong>$42,180</strong> {/* @ts-ignore */}
                                    <tc-sparkline
                                        data="30,38,35,44,40,50,47,55"
                                        height="24"
                                        width="80"
                                    ></tc-sparkline>{' '}
                                    <span
                                        style={{ color: 'var(--tc-success)', fontSize: '0.85rem' }}
                                    >
                                        +12.4%
                                    </span>
                                </p>
                                ...
                                >
                                    ...
                                    ></tc-sparkline>{' '}
                                    <span
                                        style={{ color: 'var(--tc-danger)', fontSize: '0.85rem' }}
                                    >
                                        −7.1%
                                    </span>
                                </p>
