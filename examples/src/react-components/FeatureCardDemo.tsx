	...
	<div className="container my-5">
		<div className="row mb-4">
			<div className="col-12">
				<h1 className="display-4 text-gradient-primary mb-2">FeatureCard</h1>
		...
		{/* ── Full feature grid mirroring the design/ reference ── */}
		<div className="row mb-5">
			<div className="col-12">
				<h2 className="h5 mb-3">Feature grid — all seven tiles</h2>
		...
		<div className="row mb-5">
			<div className="col-12">
				<Card>
					<h2 className="h5 mb-3">Size variants</h2>
...
<div className="component-feature-card-grid">
  <FeatureCard
    ...
    eyebrow="Build pipeline"
    title="From asset to player in minutes"
    description="Automated processing optimizes your assets and pushes them live."
    visual={
      <Pipeline
        steps={[
          { num: '01', title: 'Upload',  sub: 'assets + tags' },
          { num: '02', title: 'Filter',  sub: 'by category' },
          { num: '03', title: 'Build',   sub: 'compress + scale', state: 'live' },
          { num: '04', title: 'Deploy',  sub: 'edge CDN' },
          { num: '05', title: 'Rollback', sub: 'one click' },
        ]}
      />
    }
  />
