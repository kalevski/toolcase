...
const COLUMNS: TableColumn[] = [
    {
        key: 'key',
        header: 'Key',
        render: (row: RowT) => `<span class="perch-admin-mono">${escapeHtml(row.key)}</span>`,
    },
    {
        key: 'description',
        header: 'Description',
        render: (row: RowT) => (row.description ? escapeHtml(row.description) : `<span class="perch-admin-hint">—</span>`),
    },
    {
        key: 'updatedAt',
        header: 'Updated',
        render: (row: RowT) => `<span class="perch-admin-hint">${escapeHtml(fmtDate(row.updatedAt))}</span>`,
    },
    {
        key: 'actions',
        header: '',
            ...
            {form && (
                ...
                >
                    ...
                    <FormGroup title="Value">
                        ...
                        <p className="perch-admin-hint">The value is never shown at creation — reveal it afterwards.</p>
                    </FormGroup>
                </FormModal>
            )}
