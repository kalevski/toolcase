...
export function LoadingState({
    ...
    return (
        <div className="perch-loading" role="status" aria-busy="true" aria-label={label}>
            {shape === 'text' && <tc-skeleton variant="text" count={count} />}

            {shape === 'cards' && (
                <div className="perch-card-grid">
                    {items.map((_, i) => (
                        <div className="perch-card perch-skeleton-card" key={i}>
            ...
            {shape === 'rows' && (
                <div className="perch-skeleton-rows">
                    {items.map((_, i) => (
            ...
            {shape === 'detail' && (
                <div className="perch-skeleton-detail">
...
export function EmptyState({
    ...
    return (
        <tc-empty-state icon={icon}>
            <strong className="perch-empty-title">{title}</strong>
            {description && <p className="perch-empty-desc">{description}</p>}
            {children}
        </tc-empty-state>
    )
}
