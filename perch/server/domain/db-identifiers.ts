// Pure validation + quoting for database identifiers (perch_database_management.md
 ...
 *  Deliberately far stricter than what the engines allow — perch-created objects
 *  are plain snake_case names; anything fancier is created outside perch. */
...
/** Account names perch refuses to create, drop, or re-password (§10). The
 ...
 * lowercases (both engines fold unquoted identifiers anyway; perch normalizes so
