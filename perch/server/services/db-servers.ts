// Database-server registry service (perch_database_management.md §7) — the
 ...
 *  block: registration is owner-only and audited (§10). */
...
function validateAdminPassword(raw: unknown): string {
    ...
    // the engine's business; perch only refuses empties.
