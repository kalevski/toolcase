...
// (perch_better.md C3). The daemon serves GET /schema (hand-kept, CI-linted
...
//
// Defaults: schemaUrl = $PERCH_NGINXPILOT_ADMIN_URL/schema (or http://127.0.0.1:9090/schema),
...
const base = process.env.PERCH_NGINXPILOT_ADMIN_URL?.replace(/\/+$/, '') || 'http://127.0.0.1:9090'
