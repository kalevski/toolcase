...
export const Drawer: React.FC<DrawerProps> = ({
	...
	useEffect(() => {
		...
		// Move focus into the panel on next frame
	...
	const drawer = (
		<div
			...
			aria-hidden={!open}
			onClick={pinned ? undefined : (e) => { if (e.target === e.currentTarget) onClose() }}
		>
			<div
				ref={panelRef}
			...
			>
				{(title != null) && (
					<div className="component-drawer__header">
						<span id={titleId} className="component-drawer__title">{title}</span>
						<button
							type="button"
				...
				<div className="component-drawer__body">
					{children}
				</div>
			</div>
		</div>
