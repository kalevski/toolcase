...
export const MarkdownEditor: React.FC<MarkdownEditorProps> = ({
	...
	const applyWrap = useCallback((wrap: [string, string]) => {
	...
	return (
		<div className={rootClass}>
			{label && (
				<label htmlFor={editorId} className="form-label component-markdown-editor__label">
					{label}
				</label>
			)}
			...
			<div className="component-markdown-editor__shell" style={{ height: heightStyle }}>
				...
				{/* Preview pane — rendered via iframe srcdoc to sandbox content */}
				{tab === 'preview' && (
