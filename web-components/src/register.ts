...
export function register(): void {
    ...
    customElements.define('tc-combo-counter', ComboCounter)
    ...
    customElements.define('tc-crosshair', Crosshair)
    ...
    customElements.define('tc-item-tooltip', ItemTooltip)
    ...
    customElements.define('tc-combo-box', ComboBox)
    ...
    customElements.define('tc-gantt-chart', GanttChart)
    ...
    customElements.define('tc-json-editor', JSONEditor)
    ...
    customElements.define('tc-list-row', ListRow)
    ...
    customElements.define('tc-normal-map-generator', NormalMapGenerator)
    ...
    customElements.define('tc-slider', Slider)
