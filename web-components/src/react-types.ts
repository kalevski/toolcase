...
export interface ToolcaseIntrinsicElements {
    ...
    'tc-mobile-shell': TcProps<{ 'data-key'?: string | number; 'edge'?: string | number; 'pane-bg'?: string | number; 'scroll-restore'?: string | number; onTcShellScroll?: (e: CustomEvent) => void }>
    ...
    'tc-step-pager': TcProps<{ 'back-label'?: string | number; 'close-label'?: string | number; 'done-label'?: string | number; 'heading'?: string | number; 'hint-label'?: string | number; 'index'?: string | number; 'keep-awake'?: boolean; 'next-label'?: string | number; 'swipe-hint'?: string | number; 'wake-label'?: string | number; onTcStepPagerChange?: (e: CustomEvent) => void; onTcStepPagerClose?: (e: CustomEvent) => void; onTcStepPagerDone?: (e: CustomEvent) => void }>
